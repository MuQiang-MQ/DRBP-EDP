...
class PredictionThread(QThread):
    ...
    def __init__(self, sequences, tokenizer, stage1_model, stage2_model, parent=None):
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.text_sequence.setFixedHeight(150)
    ...
    def showHelp(self):
        help_text = (
            ...
            "4. Ensure that all sequences contain only valid amino acid characters (ACDEFGHIKLMNPQRSTVWY).\n"
            "5. The maximum number of sequences for file input is 1000.\n\n"
            "Warnings:\n"
